        ...
        <form>
          <div class="row align-items-end">
            ...
            <div class="col-auto d-grid gap-2 mx-auto mb-3">
              <a href="contact.php"><button type="button" class="btn btn-outline-success rounded-2 px-lg-3 text-bg-success">BOOK NOW</button></a>
        </div>
        </form>
      </div>
    </div>
...
<br><br>
<!-- about -->
<div class="container-xxl py-5 mt-lg-1 mb-lg-5 g-1">
  <div class="container">
